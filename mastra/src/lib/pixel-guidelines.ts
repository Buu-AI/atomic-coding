...
export function buildPixelSystemPrompt(): string {
  const sections = [
    ...
    "For 2D character animation sets and parallax background layers, use generate-sprite-animation-pack instead of generate-polished-visual-pack.",
    "",
    ...
    "",
    "## Hard Constraints",
    "- Every non-animation-pack asset MUST use generate-polished-visual-pack. Never pretend assets exist without calling the tool.",
    "- Every 2D character animation pack MUST use generate-sprite-animation-pack. Never invent animation sheets or frame layouts.",
