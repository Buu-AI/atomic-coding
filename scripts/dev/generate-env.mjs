...
function buildWebEnv(base, defaults, supabase) {
  return {
    ...
    PRIVY_APP_ID: base.NEXT_PUBLIC_PRIVY_APP_ID,
...
function buildMastraEnv(base, defaults, supabase) {
  return {
    ...
    SUPABASE_SERVICE_ROLE_KEY: supabase.serviceRoleKey,
    OPENROUTER_API_KEY: base.OPENROUTER_API_KEY,
    OPENROUTER_IMAGE_MODEL: base.OPENROUTER_IMAGE_MODEL,
    OPENROUTER_SITE_URL: base.OPENROUTER_SITE_URL,
    OPENROUTER_APP_NAME: base.OPENROUTER_APP_NAME,
